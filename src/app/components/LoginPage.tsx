...
export function LoginPage() {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      // ✅ Reload profile from Appwrite so dashboard shows THIS user's data immediately
      await reloadUser();
      navigate("/dashboard");
    } catch (err: any) {
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 to-teal-600/10 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Track your coding progress across platforms and showcase your
            developer journey.
          </p>
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div
                key={s.label}
                className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-3"
              >
                <p className="text-primary text-xl" style={{ fontWeight: 700 }}>
                  {s.val}
                </p>
